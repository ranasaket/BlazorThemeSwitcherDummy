...
function dropDown(e) { if (!document.querySelector(".dropdown-hover")) { event.stopPropagation(), event.preventDefault(); for (var t = e.parentElement.parentElement.children, a = 0; a < t.length; a++)t[a].lastElementChild != e.parentElement.lastElementChild && t[a].lastElementChild.classList.remove("show"); e.nextElementSibling.classList.contains("show") ? e.nextElementSibling.classList.remove("show") : e.nextElementSibling.classList.add("show") } } function sidebarColor(e) { for (var t = e.parentElement.children, a = e.getAttribute("data-color"), n = 0; n < t.length; n++)t[n].classList.remove("active"); e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active"), document.querySelector(".sidenav").setAttribute("data-color", a), document.querySelector("#sidenavCard") && (e = ["btn", "btn-sm", "w-100", "mb-0", "bg-gradient-" + a], (a = document.querySelector("#sidenavCard+.btn")).removeAttribute("class"), a.classList.add(...e)) } function sidebarType(e) {
    ...
    for (var r, o, c, d = document.querySelector(".sidenav"),
        s = 0;
        s < l.length; s++)
    ...
    if ("bg-default" == a && n)
    {
        ...
        for (let e = 0; e < g.length; e++)g[e].classList.add("text-white"),
...
function toggleNavLinksColor(e)
{
    let t = document.querySelectorAll(".navbar-main .nav-link, .navbar-main .breadcrumb-item, .navbar-main .breadcrumb-item a, .navbar-main h6"),
        a = document.querySelectorAll(".navbar-main .sidenav-toggler-line"); "blur" === e ? (t.forEach(e => { e.classList.remove("text-white") }),
            a.forEach(e => {
                e.classList.add("bg-dark"),
                e.classList.remove("bg-white")
            })) : "transparent" === e && (t.forEach(e => { e.classList.add("text-white") }),
                a.forEach(e => { e.classList.remove("bg-dark"), e.classList.add("bg-white") }))
}
function navbarBlurOnScroll(e) {
    ...
    window.onscroll = debounce("true" == e ? function ()
    {
        ...
        -1 < navigator.platform.indexOf("Win") && (a = document.querySelector(".main-content"), "true" == e ? a.addEventListener("ps-scroll-y",
            debounce(
                function ()
                {
                    (5 < a.scrollTop ? l : s)()
                }, 10)) : a.addEventListener("ps-scroll-y",
        debounce(function () { s() }, 10)))
}
function
    debounce(n, i, l)
{
...
} document.addEventListener("DOMContentLoaded", function ()
{
    ...
    });[].slice.call(document.querySelectorAll(".toast-btn")).map(function (t)
    {
        ...
        {
            var e = document.getElementById(t.dataset.target); e && bootstrap.Toast.getInstance(e).show()
        })
    })
